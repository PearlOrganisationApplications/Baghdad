//https://i.diawi.com/PutJkG
import 'dart:async';
import 'dart:io';
import 'package:animated_splash_screen/animated_splash_screen.dart';
import 'package:baghdad/webview_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    SystemChrome.setSystemUIOverlayStyle(const SystemUiOverlayStyle(
        statusBarColor: Color(0xffffffff), statusBarBrightness: Brightness.dark));
    return GetMaterialApp(
      ...
      home: AnimatedSplashScreen(
        ...
        duration: 3000,
        splashIconSize: 180,
        splash: "assets/bagdad-edit-logo.png",
  ...
  Widget build(BuildContext context) {
   /* Future.delayed(const Duration(milliseconds: 5000), () {
    ...
    return  AnnotatedRegion<SystemUiOverlayStyle>( value:const SystemUiOverlayStyle(
      statusBarColor: Color(0xff1f67ca),
                ...
                children: <Widget>[
                  Center(
                    child: LoadingAnimationWidget.twistingDots(
                      ...
                      rightDotColor: const Color(0xff1f67ca),
                      size: 80,
                    ),
                  ),
                ],
      ...
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          actions: <Widget>[
            ElevatedButton(
              style: ButtonStyle(
                backgroundColor: MaterialStateProperty.all<Color>(const Color(0xff1f67ca)),
              ),
              onPressed: () {
            ...
            ElevatedButton(
              style: ButtonStyle(
                  backgroundColor:
                  MaterialStateProperty.all<Color>(const Color(0xff1f67ca))),
              onPressed: () {
